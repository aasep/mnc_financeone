...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Laporan Simpanan LPS  (Simpanan Pihak Ke 3)<small></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Simpanan LPS (Simpanan Pihak Ke 3) </a>
						<i class="fa fa-angle-right"></i>
					</li>
			...
			<!-- BEGIN VALIDATION STATES-->
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Simpanan LPS (Simpanan Pihak Ke 3)
							</div>
							<div class="tools">
...
({
type: "POST",
url: "module/report/ajax_report_simp_lps.php",
data: dataString1,
cache: false,
