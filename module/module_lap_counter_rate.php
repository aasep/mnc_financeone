...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			Laporan Counter Rate <small></small>
			</h3>
			<div class="page-bar">
			...
			<!-- BEGIN VALIDATION STATES-->
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Input Laporan Counter Rate
							</div>
							<!--<div class="tools">
...
({
type: "POST",
url: "module/report/ajax_report_counter_rate.php",
data: dataString1,
cache: false,
