...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Laporan Simpanan Pihak ke Tiga <small></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Laporan Simpanan Pihak ke Tiga</a>
						<i class="fa fa-angle-right"></i>
					</li>
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Report Laporan Simpanan Pihak ke Tiga <span class="step-title">
								 </span>
							</div>
