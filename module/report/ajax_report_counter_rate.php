...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
JOIN Referensi_Counter_Rate_LPS c ON c.CRLPS_Level_2 = b.CRLPS_Level_2 
WHERE a.JumlahBulanLaporan >='100000001' and a.JumlahBulanLaporan <'200000001'
and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) <='33'
and a.JenisMataUang = 'IDR'
UNION ALL 
SELECT SUM(a.JumlahBulanLaporan) AS Deposito
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
JOIN Referensi_Counter_Rate_LPS c ON c.CRLPS_Level_2 = b.CRLPS_Level_2
WHERE  a.JumlahBulanLaporan >'200000001' and a.JumlahBulanLaporan<'500000001'
and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) <='33'
and a.JenisMataUang = 'IDR'
UNION ALL 
SELECT SUM(a.JumlahBulanLaporan) AS Deposito
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
JOIN Referensi_Counter_Rate_LPS c ON c.CRLPS_Level_2 = b.CRLPS_Level_2
WHERE a.JumlahBulanLaporan >='1000000001' and a.JumlahBulanLaporan <'2000000001'
and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) <='33'
and a.JenisMataUang = 'IDR'
UNION ALL 
SELECT SUM(a.JumlahBulanLaporan) AS Deposito
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
JOIN Referensi_Counter_Rate_LPS c ON c.CRLPS_Level_2 = b.CRLPS_Level_2
WHERE  a.JumlahBulanLaporan >='2000000001' and a.JumlahBulanLaporan <'5000000001'
and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) <='33'
and a.JenisMataUang = 'IDR'
UNION ALL 
SELECT SUM(a.JumlahBulanLaporan) AS Deposito
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
JOIN Referensi_Counter_Rate_LPS c ON c.CRLPS_Level_2 = b.CRLPS_Level_2
WHERE a.JumlahBulanLaporan > '5000000000'
and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) <='33'
and a.JenisMataUang = 'IDR'
UNION ALL 
SELECT SUM(a.JumlahBulanLaporan) AS Deposito
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
JOIN Referensi_Counter_Rate_LPS c ON c.CRLPS_Level_2 = b.CRLPS_Level_2
WHERE a.JumlahBulanLaporan >='0' and a.JumlahBulanLaporan <'100000001'
and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) >'33' and DateDiff(Day,a.JangkaWaktuMulai,a.JangkaWaktuJatuhTempo) <='95'
and a.JenisMataUang <>'IDR' AND b.CRLPS_Level_2='CRLPS201000000'
UNION ALL
SELECT SUM(a.JumlahBulanLaporan) AS Deposito
FROM $table_banklain a
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
...
<div class="portlet box blue" id="flash-report" >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-book"></i> List Counter Rate 
                            </div>
                        </div>
