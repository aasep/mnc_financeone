...
error_reporting(1);
logActivity("generate longform",date('Y_m_d_H_i_s'));
/*
...
$var_tabel=date('Ymd',strtotime($var_tgl));
$var_tabel2=date('Ymd',strtotime($before_neraca));

#############################################################################################
$table_asetkredit="DM_AsetKredit_$var_tabel";
$table_asetkredit2="DM_AsetKredit_$var_tabel2";
...
$qcekTable=" select top 1* from  $table_asetkredit2 ";
$res_cek=odbc_exec($connection2, $qcekTable);
if (!$res_cek){
        echo "<div class='lert alert-danger' align='center'> <br><b> Tabel $table_asetkredit2 Tidak tersedia ... ! </b> <br><br></div>";
        die();
}

$table_giro="DM_LiabilitasGiro_$var_tabel";
$table_giro2="DM_LiabilitasGiro_$var_tabel2";
$table_tabungan="DM_LiabilitasTabungan_$var_tabel";
$table_tabungan2="DM_LiabilitasTabungan_$var_tabel2";
$table_deposito="DM_LiabilitasDeposito_$var_tabel";
$table_deposito2="DM_LiabilitasDeposito_$var_tabel2";
$table_banklain="DM_LiabilitasKepadaBankLain_$var_tabel";
$table_banklain2="DM_LiabilitasKepadaBankLain_$var_tabel2";
...
$qcekTable=" select top 1* from  $table_giro2 ";
$res_cek=odbc_exec($connection2, $qcekTable);
if (!$res_cek){
        echo "<div class='lert alert-danger' align='center'> <br><b> Tabel $table_giro2 Tidak tersedia ... ! </b> <br><br></div>";
       // die();
}
...
$qcekTable=" select top 1* from  $table_tabungan2 ";
$res_cek=odbc_exec($connection2, $qcekTable);
if (!$res_cek){
        echo "<div class='lert alert-danger' align='center'> <br><b> Tabel $table_tabungan2 Tidak tersedia ... ! </b> <br><br></div>";
        //die();
}
...
$qcekTable=" select top 1* from  $table_deposito2 ";
$res_cek=odbc_exec($connection2, $qcekTable);
if (!$res_cek){
        echo "<div class='lert alert-danger' align='center'> <br><b> Tabel $table_deposito2 Tidak tersedia ... ! </b> <br><br></div>";
        //die();
}
...
$qcekTable=" select top 1* from  $table_banklain2 ";
$res_cek=odbc_exec($connection2, $qcekTable);
if (!$res_cek){
        echo "<div class='lert alert-danger' align='center'> <br><b> Tabel $table_banklain2 Tidak tersedia ... ! </b> <br><br></div>";
        //die();
}
...
$query=" select Lap_Keu_Level_3,Lap_Keu_Level_3_Description,urut from Referensi_Laporan_Keuangan order by urut asc ";
$result=odbc_exec($connection2, $query);
        ...
        while ($row=odbc_fetch_array($result)) {
           //GET LAP_KEU_LEVEL_3
            ...
            #### CURRENT DATE ################
            $query_lf1 =" SELECT SUM(Nominal)/1000000 as jml_nominal FROM DM_Journal a WITH (NOLOCK) ";
            ...
            $q_giro_phk3=" and nominal > '0' "; 

            if ($baris=='3' ){
                $query_fixed=$query_lf1.$q_giro_phk3;
                
            } else  if ($baris=='20' ) {
                $query_fixed =" SELECT SUM(Nominal)/1000000 as jml_nominal FROM DM_Journal a WITH (NOLOCK) 
JOIN Referensi_GL_02 b ON b.GLNO = a.KodeGL AND b.PRODNO = a.KodeProduct 
JOIN Referensi_Laporan_Keuangan c ON c.Lap_Keu_Level_3 = b.Lap_Keu_Level_3 
WHERE a.DataDate='$var_tgl' AND b.Lap_Keu_Level_3='Lap_Keu101000003' and nominal < '0' ";
//echo  $query_fixed;
               // die();
            } else {
                 $query_fixed=$query_lf1;
            }
...
*/
            $result_lf1=odbc_exec($connection2, $query_fixed);
            $row1=odbc_fetch_array($result_lf1);
            $nominal_neraca["$baris"]=$row1['jml_nominal'];
            // if ($baris =='3')
            // {
            //     echo $row1['jml_nominal'];
            //     die();
            // }
            //echo "<pre>";
            //var_dump($nominal_neraca["$baris"]);
            ...
            //die();
            #### BEFORE DATE  NERACA ################
            $query_lf2 =" SELECT SUM(Nominal)/1000000  as jml_nominal FROM DM_Journal a WITH (NOLOCK) ";
            ...
            if ($baris=='3' ){
                $query_fixed2=$query_lf2.$q_giro_phk3;
               // echo  $query_fixed2;
               // die();
            } else  if ($baris=='20' ) {
                $query_fixed2 =" SELECT SUM(Nominal)/1000000 as jml_nominal FROM DM_Journal a WITH (NOLOCK) 
JOIN Referensi_GL_02 b ON b.GLNO = a.KodeGL AND b.PRODNO = a.KodeProduct 
JOIN Referensi_Laporan_Keuangan c ON c.Lap_Keu_Level_3 = b.Lap_Keu_Level_3 
WHERE a.DataDate='$before_neraca' AND b.Lap_Keu_Level_3='Lap_Keu101000003' and nominal < '0' ";

            } else {
                 $query_fixed2=$query_lf2;
            }


            $result_lf2=odbc_exec($connection2, $query_fixed2);
            ...
            $query_lf3 =" SELECT SUM(Nominal)/1000000  as jml_nominal FROM DM_Journal a WITH (NOLOCK) ";
...
$query_WE=" select (nilai/1000000) as nilai_we from weighted_average where DataDate='$var_tgl' ";
$result_WE=odbc_exec($connection2, $query_WE);
$row_WE=odbc_fetch_array($result_WE);
$weight_average=$row_WE['nilai_we'];
//echo "$query_WE";
//die();
...
$objPHPExcel->getActiveSheet()->getStyle('B91:D135')->applyFromArray($styleArrayBorder1);
//FILL COLOR
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A138:D138');
...
$objPHPExcel->getActiveSheet()->getStyle('A137:D138')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
$objPHPExcel->getActiveSheet()->setCellValue('A3', "Per $var_tgl ");
...
$objPHPExcel->getActiveSheet()->setCellValue('A42', "Per $var_tgl ");
$objPHPExcel->getActiveSheet()->setCellValue('A43', 'Disajikan Dalam Jutaan Rupiah Kecuali Dinyatakan yang lain');

$objPHPExcel->getActiveSheet()->setCellValue('C46', "$var_tgl");
$objPHPExcel->getActiveSheet()->setCellValue('D46', $before_neraca);
...
$objPHPExcel->getActiveSheet()->setCellValue('A87', "Untuk Periode yang berakhir pada tanggal  $var_tgl ");
$objPHPExcel->getActiveSheet()->setCellValue('A88', 'Disajikan Dalam Jutaan Rupiah Kecuali Dinyatakan yang lain');

$objPHPExcel->getActiveSheet()->setCellValue('C91', "$var_tgl");
$objPHPExcel->getActiveSheet()->setCellValue('D91', $before_rugi_laba);
...
$objPHPExcel->getActiveSheet()->setCellValue('B106', '  Keuntungan (kerugian) yang belum direalisasi dari efek yang diperdagangkan');
$objPHPExcel->getActiveSheet()->setCellValue('B107', '  Lain - lain');
$objPHPExcel->getActiveSheet()->setCellValue('B108', '  Jumlah Pendapatan Operasi Lainnya');


$objPHPExcel->getActiveSheet()->setCellValue('B109', 'Beban (Pemulihan) kerugian penurunan nilai');
$objPHPExcel->getActiveSheet()->setCellValue('B110', '  Aset Keuangan');
$objPHPExcel->getActiveSheet()->setCellValue('B111', '  Aset Non Keuangan');
$objPHPExcel->getActiveSheet()->setCellValue('B112', '  Jumlah Beban Kerugian Penurunan Nilai');
$objPHPExcel->getActiveSheet()->setCellValue('B113', 'Beban Operasional lainnya');
$objPHPExcel->getActiveSheet()->setCellValue('B114', '  Umum dan administrasi ');
$objPHPExcel->getActiveSheet()->setCellValue('B115', '  Tenaga Kerja');
$objPHPExcel->getActiveSheet()->setCellValue('B116', '  Beban Pensiun dan imbalan pasca kerja lainnya');
$objPHPExcel->getActiveSheet()->setCellValue('B117', '  Lainnya');
$objPHPExcel->getActiveSheet()->setCellValue('B118', '  Jumlah Beban Operasional lainnya');


$objPHPExcel->getActiveSheet()->setCellValue('B119', 'Beban Operasional lainnya - Bersih');
$objPHPExcel->getActiveSheet()->setCellValue('B120', 'LABA (RUGI) OPERASIONAL');
$objPHPExcel->getActiveSheet()->setCellValue('B121', 'PENDAPATAN (BEBAN) NON OPERASIONAL');
$objPHPExcel->getActiveSheet()->setCellValue('B122', '  Hasil Sewa');
$objPHPExcel->getActiveSheet()->setCellValue('B123', '  Keuntungan penjualan dan pengahapusan aset tetap');
$objPHPExcel->getActiveSheet()->setCellValue('B124', '  Lainnya - bersih');
$objPHPExcel->getActiveSheet()->setCellValue('B125', 'PENDAPATAN (BEBAN) NON OPERASIONAL - BERSIH');
$objPHPExcel->getActiveSheet()->setCellValue('B126', 'LABA (RUGI) SEBELUM PAJAK PENGHASILAN');
$objPHPExcel->getActiveSheet()->setCellValue('B127', 'MANFAAT (BEBAN) PAJAK');
$objPHPExcel->getActiveSheet()->setCellValue('B128', 'LABA (RUGI) BERSIH TAHUN BERJALAN');

$objPHPExcel->getActiveSheet()->setCellValue('B129', 'PENDAPATAN KOMPREHENSIF LAIN');
$objPHPExcel->getActiveSheet()->setCellValue('B130', 'Perubahan nilai wajar efek tersedia untuk dijual');
$objPHPExcel->getActiveSheet()->setCellValue('B131', 'manfaat (Beban) pajak terkait dengan komponen');
$objPHPExcel->getActiveSheet()->setCellValue('B132', '   Pendapatan Komprehensif Lainnya');
$objPHPExcel->getActiveSheet()->setCellValue('B133', 'Jumlah pendapatan komprehensif tahun berjalan setelah pajak');
$objPHPExcel->getActiveSheet()->setCellValue('B134', 'TOTAL LABA (RUGI) KOMPREHENSIF TAHUN BERJALAN');
$objPHPExcel->getActiveSheet()->setCellValue('B135', 'Laba (Rugi) per Saham');

$objPHPExcel->getActiveSheet()->setCellValue("A137", "Lihat catatan atas laporan keuangan yang merupakan bagian tak terpisahkan ");
$objPHPExcel->getActiveSheet()->setCellValue("A138", "dari laporan keuangan secara keseluruhan ");

##### mulai dari excel row 9 sd 25   
$ix1=1;
for ($barisx1=9; $barisx1 <=25 ; $barisx1++) { 

    if ( $barisx1=='15' || $barisx1=='16' || $barisx1=='17' || $barisx1=='19'){}
        else {
        $objPHPExcel->getActiveSheet()->setCellValue("C$barisx1", floatval($nominal_neraca["$ix1"]));
        $objPHPExcel->getActiveSheet()->setCellValue("D$barisx1", floatval($nominal_neraca_sebelumnya["$ix1"]));
        $ix1++;
    }
...
//PIHAK BERELASI
$query=" select sum(JumlahKreditPeriodeLaporan)/1000000 as Nominal_PBerelasi from $table_asetkredit where DataDate='$var_tgl' and Status_Pihak_Terkait like '%Y%' ";
$query2=" select sum(JumlahKreditPeriodeLaporan)/1000000 as Nominal_PBerelasi from $table_asetkredit2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%Y%' ";
$result=odbc_exec($connection2, $query);
...
$cpihak_berelasi=$row['Nominal_PBerelasi'];
//echo $query2;
//die();
$dpihak_berelasi=$row2['Nominal_PBerelasi'];


//PIHAK KETIGA
$query=" select sum(JumlahKreditPeriodeLaporan)/1000000 as Nominal_PKetiga from $table_asetkredit where DataDate='$var_tgl' and Status_Pihak_Terkait like '%N%' ";
$query2=" select sum(JumlahKreditPeriodeLaporan)/1000000 as Nominal_PKetiga from $table_asetkredit2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%N%' ";
$resultx=odbc_exec($connection2, $query);
$resulty=odbc_exec($connection2, $query2);

//echo $query2;
//die();
$row=odbc_fetch_array($resultx);
$row2=odbc_fetch_array($resulty);
$cpihak_ketiga=$row['Nominal_PKetiga'];
$dpihak_ketiga=$row2['Nominal_PKetiga'];


$objPHPExcel->getActiveSheet()->setCellValue("C16", floatval($cpihak_berelasi));
$objPHPExcel->getActiveSheet()->setCellValue("C17", floatval($cpihak_ketiga));
$objPHPExcel->getActiveSheet()->setCellValue("C19", "=SUM(C16:C18)");
$objPHPExcel->getActiveSheet()->setCellValue("D16", floatval($dpihak_berelasi));
$objPHPExcel->getActiveSheet()->setCellValue("D17", floatval($dpihak_ketiga));
...
$i=14;
for ($baris=48; $baris <=73 ; $baris++) { 
    if ($baris=='49' || $baris=='50' || $baris=='51' || $baris=='52' || $baris=='63' || $baris=='64' || $baris=='65' || $baris=='70' || $baris=='71') {}
        else {
        $objPHPExcel->getActiveSheet()->setCellValue("C$baris", floatval((-1)*$nominal_neraca["$i"]));
        $objPHPExcel->getActiveSheet()->setCellValue("D$baris", floatval((-1)*$nominal_neraca_sebelumnya["$i"]));
        $i++;
    }
}
...
//untuk pihak berelasi hubungan dengan bank==1 Baris ke 50 and Status_Pihak_Terkait like '%Y%'
//untuk pihak ke tiga hubungan dengan bank==2 basris ke 51 and Status_Pihak_Terkait like '%N%'
###### GIRO #####################################
$query_giro="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_giro where DataDate='$var_tgl'  and Status_Pihak_Terkait like '%Y%' ";
$query_giro2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_giro2 where DataDate='$before_neraca'  and Status_Pihak_Terkait like '%Y%' ";
$result_giro=odbc_exec($connection2, $query_giro);
$result_giro2=odbc_exec($connection2, $query_giro2);
$row_giro=odbc_fetch_array($result_giro);
$row_giro2=odbc_fetch_array($result_giro2);
$cpihak_berelasi_giro=$row_giro['Nominal_PBerelasi'];
$dpihak_berelasi_giro2=$row_giro2['Nominal_PBerelasi'];

###### TABUNGAN #####################################
$query_tabungan="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_tabungan where DataDate='$var_tgl' and Status_Pihak_Terkait like '%Y%' ";
$query_tabungan2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_tabungan2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%Y%' ";
$result_tabungan=odbc_exec($connection2, $query_tabungan);
$result_tabungan2=odbc_exec($connection2, $query_tabungan2);
$row_tabungan=odbc_fetch_array($result_tabungan);
$row_tabungan2=odbc_fetch_array($result_tabungan2);
$cpihak_berelasi_tabungan=$row_tabungan['Nominal_PBerelasi'];
$dpihak_berelasi_tabungan2=$row_tabungan2['Nominal_PBerelasi'];

###### DEPOSITO #####################################
$query_deposito="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_deposito where DataDate='$var_tgl' and Status_Pihak_Terkait like '%Y%' ";
$query_deposito2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_deposito2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%Y%' ";
$result_deposito=odbc_exec($connection2, $query_deposito);
$result_deposito2=odbc_exec($connection2, $query_deposito2);
$row_deposito=odbc_fetch_array($result_deposito);
$row_deposito2=odbc_fetch_array($result_deposito2);
$cpihak_berelasi_deposito=$row_deposito['Nominal_PBerelasi'];
$dpihak_berelasi_deposito2=$row_deposito2['Nominal_PBerelasi'];

###### BANK LAIN  #####################################
$query_banklain="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_banklain where DataDate='$var_tgl' and Status_Pihak_Terkait like '%Y%' ";
$query_banklain2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_banklain2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%Y%' ";
$result_banklain=odbc_exec($connection2, $query_banklain);
$result_banklain2=odbc_exec($connection2, $query_banklain2);
$row_banklain=odbc_fetch_array($result_banklain);
$row_banklain2=odbc_fetch_array($result_banklain2);
$cpihak_berelasi_banklain=$row_banklain['Nominal_PBerelasi'];
$dpihak_berelasi_banklain2=$row_banklain2['Nominal_PBerelasi'];


// echo $query_giro."<br>";
// echo $query_tabungan."<br>";
// echo $query_deposito."<br>";
// echo $query_banklain."<br>";
// die();
$jum_total_Relc=$cpihak_berelasi_giro+$cpihak_berelasi_tabungan+$cpihak_berelasi_deposito+$cpihak_berelasi_banklain;
$jum_total_Reld=$dpihak_berelasi_giro2+$dpihak_berelasi_tabungan2+$dpihak_berelasi_deposito2+$dpihak_berelasi_banklain2;

################2222222============

###### GIRO #####################################
$query_giro="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_giro where DataDate='$var_tgl'  and Status_Pihak_Terkait like '%N%' ";
$query_giro2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_giro2 where DataDate='$before_neraca'  and Status_Pihak_Terkait like '%N%' ";
$result_giro=odbc_exec($connection2, $query_giro);
$result_giro2=odbc_exec($connection2, $query_giro2);
$row_giro=odbc_fetch_array($result_giro);
$row_giro2=odbc_fetch_array($result_giro2);
...
###### TABUNGAN #####################################
$query_tabungan="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_tabungan where DataDate='$var_tgl' and Status_Pihak_Terkait like '%N%' ";
$query_tabungan2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_tabungan2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%N%' ";
$result_tabungan=odbc_exec($connection2, $query_tabungan);
$result_tabungan2=odbc_exec($connection2, $query_tabungan2);
$row_tabungan=odbc_fetch_array($result_tabungan);
$row_tabungan2=odbc_fetch_array($result_tabungan2);
...
###### DEPOSITO #####################################
$query_deposito="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_deposito where DataDate='$var_tgl' and Status_Pihak_Terkait like '%N%' ";
$query_deposito2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_deposito2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%N%' ";
$result_deposito=odbc_exec($connection2, $query_deposito);
$result_deposito2=odbc_exec($connection2, $query_deposito2);
$row_deposito=odbc_fetch_array($result_deposito);
$row_deposito2=odbc_fetch_array($result_deposito2);
...
###### BANK LAIN  #####################################
$query_banklain="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_banklain where DataDate='$var_tgl' and Status_Pihak_Terkait like '%N%' ";
$query_banklain2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_banklain2 where DataDate='$before_neraca' and Status_Pihak_Terkait like '%N%' ";
$result_banklain=odbc_exec($connection2, $query_banklain);
$result_banklain2=odbc_exec($connection2, $query_banklain2);
$row_banklain=odbc_fetch_array($result_banklain);
$row_banklain2=odbc_fetch_array($result_banklain2);
...
$dpihak_berelasi_banklain2=$row_banklain2['Nominal_PBerelasi'];
 ...
 die();
 */
$jum_total_Pihak3c=$cpihak_berelasi_giro+$cpihak_berelasi_tabungan+$cpihak_berelasi_deposito+$cpihak_berelasi_banklain;
$jum_total_Pihak3d=$dpihak_berelasi_giro2+$dpihak_berelasi_tabungan2+$dpihak_berelasi_deposito2+$dpihak_berelasi_banklain2;



$objPHPExcel->getActiveSheet()->setCellValue("C50", floatval($jum_total_Relc));
$objPHPExcel->getActiveSheet()->setCellValue("D50", floatval($jum_total_Reld));
$objPHPExcel->getActiveSheet()->setCellValue("C51", floatval($jum_total_Pihak3c));
$objPHPExcel->getActiveSheet()->setCellValue("D51", floatval($jum_total_Pihak3d));

$objPHPExcel->getActiveSheet()->setCellValue("C52", "=SUM(C50:C51)");
$objPHPExcel->getActiveSheet()->setCellValue("D52", "=SUM(D50:D51)");
...
for ($i=93; $i <=131 ; $i++) { 
if ($i=='95' || $i=='96' || $i=='99' || $i=='100' || $i=='101' || $i=='106' || $i=='108' || $i=='109' || $i=='112' || $i=='113' || $i=='118' || $i=='119' || $i=='120' || $i=='121' || $i=='125' || $i=='126' || $i=='127' || $i=='128' || $i=='129' || $i=='130') {
} else {   

if ($i=='97' || $i=='110' || $i=='111' || $i=='114' || $i=='115' || $i=='117' ){
...
$objPHPExcel->getActiveSheet()->setCellValue("C$i", floatval((-1)*$nominal_neraca["$index"]));
$objPHPExcel->getActiveSheet()->setCellValue("D$i", floatval((-1)*$nominal_rugilaba_sebelumnya["$index"]));
}
...
$objPHPExcel->getActiveSheet()->setCellValue("C106", floatval((-1)*$nominal_neraca["50"]));
$objPHPExcel->getActiveSheet()->setCellValue("D106", floatval((-1)*$nominal_rugilaba_sebelumnya["50"]));
...
//------------
$objPHPExcel->getActiveSheet()->setCellValue("C108", "=SUM(C102:C107)");
$objPHPExcel->getActiveSheet()->setCellValue("D108", "=SUM(D102:D107)");

$objPHPExcel->getActiveSheet()->setCellValue("C112", "=SUM(C110:C111)");
$objPHPExcel->getActiveSheet()->setCellValue("D112", "=SUM(D110:D111)");

$objPHPExcel->getActiveSheet()->setCellValue("C118", "=SUM(C114:C117)");
$objPHPExcel->getActiveSheet()->setCellValue("D118", "=SUM(D114:D117)");
$objPHPExcel->getActiveSheet()->setCellValue("C119", "=+C112+C118");
$objPHPExcel->getActiveSheet()->setCellValue("D119", "=+D112+D118");
$objPHPExcel->getActiveSheet()->setCellValue("C120", "=+C100+C108+C119");
$objPHPExcel->getActiveSheet()->setCellValue("D120", "=+D100+D108+D119");

$objPHPExcel->getActiveSheet()->setCellValue("C125", "=SUM(C122:C124)");
$objPHPExcel->getActiveSheet()->setCellValue("D125", "=SUM(D122:D124)");
$objPHPExcel->getActiveSheet()->setCellValue("C126", "=C120+C125");
$objPHPExcel->getActiveSheet()->setCellValue("D126", "=D120+D125");

$objPHPExcel->getActiveSheet()->setCellValue("C128", "=C126+C127");
$objPHPExcel->getActiveSheet()->setCellValue("D128", "=D126+D127");


$objPHPExcel->getActiveSheet()->setCellValue("C127", "=C125+C126");
$objPHPExcel->getActiveSheet()->setCellValue("D127", "=D125+D126");

$objPHPExcel->getActiveSheet()->setCellValue("C133", "=SUM(C131:C132)");
$objPHPExcel->getActiveSheet()->setCellValue("D133", "=SUM(D131:D132)");
$objPHPExcel->getActiveSheet()->setCellValue("C134", "=+C133");
$objPHPExcel->getActiveSheet()->setCellValue("D134", "=+D133");

####################################################################################
$styleArrayColorFontwhite = array(
    'font'  => array(
        'bold'  => true,
        'color' => array('rgb' => 'FFFFFF'),
        'size'  => 11,
...
$objPHPExcel->getActiveSheet()->getStyle('AZ33')->applyFromArray($styleArrayColorFontwhite);

$objPHPExcel->getActiveSheet()->setCellValue("AZ33", floatval($weight_average));


####################################################################################

$objPHPExcel->getActiveSheet()->setCellValue("C135", "=(C128/AZ33)");
$objPHPExcel->getActiveSheet()->setCellValue("D135", "=(D128/AZ33)");
...
$objPHPExcel->getActiveSheet()->setCellValue("C15", floatval($nominal_neraca["7"]));
...
$objPHPExcel->getActiveSheet()->setCellValue("C19", "='Neraca & Laba Rugi'!C16");
$objPHPExcel->getActiveSheet()->setCellValue("C20", "='Neraca & Laba Rugi'!C17");
$objPHPExcel->getActiveSheet()->setCellValue("C21", "=SUM(C19:C20)");
$objPHPExcel->getActiveSheet()->setCellValue("C22", floatval($nominal_neraca["7"]));
$objPHPExcel->getActiveSheet()->setCellValue("C23", floatval($nominal_neraca["8"]));
$objPHPExcel->getActiveSheet()->setCellValue("C24", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C25", floatval($nominal_neraca["10"]));
$objPHPExcel->getActiveSheet()->setCellValue("C26", floatval($nominal_neraca["12"]));
$objPHPExcel->getActiveSheet()->setCellValue("C27", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C28", "='Neraca & Laba Rugi'!C21");
$objPHPExcel->getActiveSheet()->setCellValue("C29", floatval($nominal_neraca["13"]));
$objPHPExcel->getActiveSheet()->setCellValue("C30", "=SUM(C21:C29,C10:C13,C16:C17)");


$objPHPExcel->getActiveSheet()->setCellValue("C56", floatval($nominal_neraca["14"]));
//$objPHPExcel->getActiveSheet()->setCellValue("C57", floatval($nominal_neraca["16"]));
$objPHPExcel->getActiveSheet()->setCellValue("C58", "='Neraca & Laba Rugi'!C50");
$objPHPExcel->getActiveSheet()->setCellValue("C59", "='Neraca & Laba Rugi'!C51");
$objPHPExcel->getActiveSheet()->setCellValue("C60", "=SUM(C58:C59)");
$objPHPExcel->getActiveSheet()->setCellValue("C61", floatval($nominal_neraca["15"]));
$objPHPExcel->getActiveSheet()->setCellValue("C62", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C63", floatval($nominal_neraca["16"]));
$objPHPExcel->getActiveSheet()->setCellValue("C64", floatval($nominal_neraca["18"]));
$objPHPExcel->getActiveSheet()->setCellValue("C65", floatval($nominal_neraca["20"]));
$objPHPExcel->getActiveSheet()->setCellValue("C66", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C67", floatval($nominal_neraca["21"]));
$objPHPExcel->getActiveSheet()->setCellValue("C68", floatval($nominal_neraca["19"]));
$objPHPExcel->getActiveSheet()->setCellValue("C69", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C70", floatval($nominal_neraca["22"]));
$objPHPExcel->getActiveSheet()->setCellValue("C71", floatval($nominal_neraca["24"]));
$objPHPExcel->getActiveSheet()->setCellValue("C72", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C73", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C74", floatval($nominal_neraca["26"]));
$objPHPExcel->getActiveSheet()->setCellValue("C75", floatval($nominal_neraca["27"]));
$objPHPExcel->getActiveSheet()->setCellValue("C76", floatval($nominal_neraca["28"]));
$objPHPExcel->getActiveSheet()->setCellValue("C77", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C78", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C79", floatval($nominal_neraca["29"]));
$objPHPExcel->getActiveSheet()->setCellValue("C80", floatval($nominal_neraca["30"]));
$objPHPExcel->getActiveSheet()->setCellValue("C81", "='Neraca & Laba Rugi'!C74");
$objPHPExcel->getActiveSheet()->setCellValue("C82", "='Neraca & Laba Rugi'!C75");


//mulai==107====
$objPHPExcel->getActiveSheet()->setCellValue("C107", "='Neraca & Laba Rugi'!C95");
$objPHPExcel->getActiveSheet()->setCellValue("C108", "='Neraca & Laba Rugi'!C99");
$objPHPExcel->getActiveSheet()->setCellValue("C109", "='Neraca & Laba Rugi'!C100");
$objPHPExcel->getActiveSheet()->setCellValue("C110", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C111", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C112", floatval($nominal_neraca["36"]));
$objPHPExcel->getActiveSheet()->setCellValue("C113", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C114", floatval($nominal_neraca["37"]));
...
$objPHPExcel->getActiveSheet()->setCellValue("C118", floatval($nominal_neraca["39"]));
$objPHPExcel->getActiveSheet()->setCellValue("C119", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C120", "='Neraca & Laba Rugi'!C107");
...
$objPHPExcel->getActiveSheet()->setCellValue("C125", "='Neraca & Laba Rugi'!C111");
$objPHPExcel->getActiveSheet()->setCellValue("C126", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C127", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C128", floatval($nominal_neraca["42"]));
$objPHPExcel->getActiveSheet()->setCellValue("C129", floatval($nominal_neraca["43"]));
$objPHPExcel->getActiveSheet()->setCellValue("C130", "='Neraca & Laba Rugi'!C117");
...
$objPHPExcel->getActiveSheet()->setCellValue("C134", floatval($nominal_neraca["47"]));
$objPHPExcel->getActiveSheet()->setCellValue("C135", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C136", floatval($nominal_neraca["48"]));
$objPHPExcel->getActiveSheet()->setCellValue("C137", "='Neraca & Laba Rugi'!C1124");
$objPHPExcel->getActiveSheet()->setCellValue("C138", 0);
$objPHPExcel->getActiveSheet()->setCellValue("C139", "=C131+C137");
$objPHPExcel->getActiveSheet()->setCellValue("C140", "='Neraca & Laba Rugi'!C126");
$objPHPExcel->getActiveSheet()->setCellValue("C141", "=C139+C140");
