...
//PIHAK BERELASI
$query=" select sum(JumlahKreditPeriodeLaporan)/1000000 as Nominal_PBerelasi from $table_asetkredit where DataDate='$var_tgl'  ";
$query2=" select sum(JumlahKreditPeriodeLaporan)1000000 as Nominal_PBerelasi from $table_asetkredit2 where DataDate='$before_neraca'  ";
$result=odbc_exec($connection2, $query);
...
###### GIRO #####################################
$query_giro="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_giro where DataDate='$var_tgl'  ";
$query_giro2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_giro2 where DataDate='$before_neraca'  ";
...
###### TABUNGAN #####################################
$query_tabungan="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_tabungan where DataDate='$var_tgl'  ";
$query_tabungan2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_tabungan2 where DataDate='$before_neraca'  ";
...
###### DEPOSITO #####################################
$query_deposito="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_deposito where DataDate='$var_tgl'  ";
$query_deposito2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_deposito2 where DataDate='$before_neraca'  ";
...
###### BANK LAIN  #####################################
$query_banklain="  select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_banklain where DataDate='$var_tgl'  ";
$query_banklain2=" select sum(jumlahbulanlaporan)/1000000 as Nominal_PBerelasi from $table_banklain2 where DataDate='$before_neraca'  ";
...
$objPHPExcel->getActiveSheet()->setCellValue("C72", floatval($nominal_neraca["34"]));
$objPHPExcel->getActiveSheet()->setCellValue("D72", floatval($nominal_neraca_sebelumnya["34"]));


$objPHPExcel->getActiveSheet()->setCellValue("C73", "=($nominal_neraca[35]+C127)");
$objPHPExcel->getActiveSheet()->setCellValue("D73", "=($nominal_neraca_sebelumnya[35]+D127)");
...
$objPHPExcel->getActiveSheet()->setCellValue("C130", floatval($nominal_neraca["36"]));
$objPHPExcel->getActiveSheet()->setCellValue("D130", floatval($nominal_neraca_sebelumnya["36"]));
...
$objPHPExcel->getActiveSheet()->setCellValue("C134", "=(C127/AZ33)");
$objPHPExcel->getActiveSheet()->setCellValue("D134", "=(D127/AZ33)");
