...
$result=odbc_exec($connection2, $query.$q_add);
...
$objPHPExcel->getActiveSheet()->setCellValue('C37', 'Investasi pada instrumen AT1 dan Tier 2 pada bank lain 2');
...
$objPHPExcel->getActiveSheet()->setCellValue('C46', 'Faktor Pengurang Modal Pelengkap 1');
$objPHPExcel->getActiveSheet()->setCellValue('C47', '5.1     Sinking Fund ');
$objPHPExcel->getActiveSheet()->setCellValue('C48', '5.2     Investasi pada instrumen Tier 2 pada bank lain 2)');
...
$objPHPExcel->getActiveSheet()->setCellValue('F50', 'Posisi Tgl Laporan');
...
$objPHPExcel->getActiveSheet()->setCellValue('C54', 'ATMR RISIKO KREDIT 3)');
...
$objPHPExcel->getActiveSheet()->setCellValue('I15', $c15);
$objPHPExcel->getActiveSheet()->setCellValue('I13', $c13);
...
<a href="<?php echo "http://".$_SERVER['HTTP_HOST']."/fincon_dev/module/report/"."download/KPMM_".$label_tgl."_".$file_eksport.".xls";?>" class="btn btn-sm green"> Download Excel <i class="fa fa-arrow-circle-o-down"></i> </a> </div></b> 
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-advance table-hover"  width="100%">
                                                ...
                                                <td width="15%" align="center" colspan="2"><b> Posisi Laporan Th Sebelumnya </b></td>
                                                </tr>
                                                <tr class="active">
                                               ...
                                               for ($i=9; $i <= 49 ; $i++) { 
                                                ...
                                                <tr>
                                                <td align="left" > <?php echo $objPHPExcel->getActiveSheet()->getCell("A$i")->getFormattedValue('#,##0,,;(#,##0,,);"-"'); ?></td>
                                                ...
                                                <tr>
                                                <td align="left" > <?php echo $objPHPExcel->getActiveSheet()->getCell("A$i")->getFormattedValue('#,##0,,;(#,##0,,);"-"'); ?></td>
                                                <td align="left" > <?php echo $objPHPExcel->getActiveSheet()->getCell("B$i")->getFormattedValue('#,##0,,;(#,##0,,);"-"'); ?></td>
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-advance table-hover"  width="100%">
                                                <thead>
                                                <tr class="active">
                                                <td width="40%" align="center" rowspan="2" ><b></b></td>
                                                <td width="20%" align="center" colspan="2"><b> Posisi Tgl Laporan </b></td>
                                                <td width="15%" align="center" colspan="2"><b> Posisi Laporan Th Sebelumnya </b></td>
                                                <td width="15%" align="center" rowspan="2"><b> Keterangan </b></td>
                                                <td width="20%" align="center" colspan="2"><b> Posisi Tgl Laporan </b></td>
                                                <td width="15%" align="center" colspan="2"><b> Posisi Laporan Th Sebelumnya </b></td>
                                                </tr>
                                                <tr class="active">
