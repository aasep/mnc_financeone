...
from DM_Journal c
JOIN GL_02_Baru b ON c.KodeGL = b.GLNO 
...
switch ($row['FLASH_Level_3_Description']) {
    ...
    //current_date
        ...
        $result2=odbc_exec($connection, $query_currentDate.$var_curr_tgl.$var_flash.$var_flash_add);
        $row2=odbc_fetch_array($result2);
        $cash=$row2['jml_nominal'];
//echo $query_currentDate.$var_curr_tgl.$var_flash.$var_flash_add;
//die();
        $result3=odbc_exec($connection, $query_currentDate.$var_curr_tgl_min1.$var_flash.$var_flash_add);
        $row3=odbc_fetch_array($result3);
        $cash3=$row3['jml_nominal'];

        $cash5=$cash-$cash3;

        $result4=odbc_exec($connection, $query_currentDate.$var_curr_mon_min1.$var_flash.$var_flash_add);
    ...
    case "Current account - Bank Indonesia":
        ...
        $current_account_bi7=$current_account_bi-$budget;
    ...
    case "Certificate of bank Indonesia (SBI & BI call money)":
        ...
        $certificate_bi7=$certificate_bi-$budget;
    ...
    case "Interbank Placement":
        ...
        $interbank_placement7=$interbank_placement-$budget;
        break;
    case "Securities":
    ...
    case "Allowance For Loan":
        ...
        $allowence_for_loan7=$allowence_for_loan-$budget;
        break;
    case "Acceptance receivables":
        ...
        $acceptance_recevables7=$acceptance_recevables-$budget;
        break; //==================================================================================================
    case "Derivative receivables":
        ...
        $deferred_receivables6=$deferred_receivables-$deferred_receivables4;
 		...
 		$deferred_receivables7=$deferred_receivables-$budget;
    ...
    case "Fixed assets (Property, Plant Equipment)":
        ...
        $fixed_assets7=$fixed_assets-$budget;
    ...
    case "Deferred taxes":
        ...
        $deferred_taxes7=$deferred_taxes-$budget;
        break;
    case "Others - Assets":
    ...
    case "Foreclosed properties":
        ...
        $foreclose_properties7=$foreclose_properties-$budget;
    ...
    case "Current Account":
        ...
        $current_account7=$current_account-$budget;
        break;
    case "Saving Deposits":
		...
		$saving_deposits7=$saving_deposits-$budget;
    ...
    case "Time deposits":
        ...
        $time_deposits7=$time_deposits-$budget;
        break;
    case "Interbank":
    ...
    case "Derivative payable":
        ...
        $derivative_payable7=$derivative_payable-$budget;
        break;
    case "Acceptance payable":
        ...
        $acceptance_payable7=$acceptance_payable-$budget;
        break;
    case "KLBI Payable":
    ...
    case "Others Liabilities":
        ...
        $others_liabilities7=$others_liabilities-$budget;
        break;
    case "Paid in capital":
        ...
        $paid_in_capital7=$paid_in_capital-$budget;
        break;
    case "Agio ( disagio)":
        ...
        $agio_disagio7=$agio_disagio-$budget;
        break;
    case "General reserve":
        ...
        $general_reserve7=$general_reserve-$budget;
        break;
    case "Available for sale securities - net":
        ...
        $available_fss_net7=$available_fss_net-$budget;
        break;
    case "Retained earnings":
        ...
        $retained_earning7=$retained_earning-$budget;
        break;
...
$objPHPExcel->getActiveSheet()->setCellValue('H22', $others_assets);
$objPHPExcel->getActiveSheet()->setCellValue('J22', $others_assets7);
...
$objPHPExcel->getActiveSheet()->setCellValue('H28', $total_assets_curr);
...
$objPHPExcel->getActiveSheet()->setCellValue('J35', $saving_account7);
...
$objPHPExcel->getActiveSheet()->setCellValue('H37', $total_deposit_curr);
...
$objPHPExcel->getActiveSheet()->setCellValue('H38', $interbank);
$objPHPExcel->getActiveSheet()->setCellValue('J38', $interbank7);
...
$objPHPExcel->getActiveSheet()->setCellValue('H49', $total_ol_curr);
...
$objPHPExcel->getActiveSheet()->setCellValue('H56', $total_equity_curr);
...
$objPHPExcel->getActiveSheet()->setCellValue('H57', $total_deposit_curr+$total_ol_curr+$total_equity_curr);
