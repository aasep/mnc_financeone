...
error_reporting(1);
logActivity("generate umkm",date('Y_m_d_H_i_s'));
/*
...
######  CEK INDEX ###########
$q_index= " SELECT count(*) as jml FROM sys.indexes WHERE name='idxUMKM1' AND object_id = OBJECT_ID('$table_asetkredit'); ";
$res_index=odbc_exec($connection2, $q_index);
$row_idx=odbc_fetch_array($res_index);
$found=$row_idx['jml'];
//=== if not exist create index 
if ($found == 0){
$c_index1= " CREATE INDEX idxUMKM1 ON $table_asetkredit (NomorNasabah) ";
$res_cindex1=odbc_exec($connection2, $c_index1);
$c_index2= " CREATE INDEX idxUMKM2 ON $table_asetkredit (NamaLengkapDebitur) ";
$res_cindex2=odbc_exec($connection2, $c_index2);
$c_index3= " CREATE INDEX idxUMKM3 ON $table_asetkredit (KategoriUsahaDebitur) ";
$res_cindex3=odbc_exec($connection2, $c_index3);
$c_index4= " CREATE INDEX idxUMKM4 ON $table_asetkredit (jenis) ";
$res_cindex4=odbc_exec($connection2, $c_index4);
$c_index5= " CREATE INDEX idxUMKM5 ON $table_asetkredit (status) ";
$res_cindex5=odbc_exec($connection2, $c_index5);
$c_index6= " CREATE INDEX idxUMKM6 ON $table_asetkredit (kolektibilitas) ";
$res_cindex6=odbc_exec($connection2, $c_index6);
}
...
$number_row1=13;
/*
$query_A=" SELECT PihakPenyalur, sum (jumlah)as ModalKerja from (SELECT   a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit A LEFT JOIN (SELECT * FROM DM_InfoDebitur WHERE DataDate='$var_tgl') b ON a.NomorNasabah = b.NomorNasabah
...
$numA=1;
/*
$query_A=" SELECT PihakPenyalur, sum (jumlah)as ModalKerja from (
SELECT distinct a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah FROM $table_asetkredit A LEFT JOIN (SELECT * FROM DM_InfoDebitur WHERE DataDate='$var_tgl') b ON a.NomorNasabah = b.NomorNasabah WHERE 
a.jenis IN (SELECT Ref_BIGOID_JenisKreditPembiayaan.KodeInternal
from Ref_BIGOID_JenisKreditPembiayaan WHERE StatusUMKM='y') AND a.GolonganDebitur IN (SELECT Ref_BIGOID_GolonganDebitur.KodeInternal
FROM Ref_BIGOID_GolonganDebitur WHERE StatusUMKM='y')
AND  a.KategoriUsahaDebitur <>'99' AND a.[Status] NOT IN ('2','8')
)as table1 group by PihakPenyalur ";
*/

$query_A=" SELECT PihakPenyalur, sum (jumlah)as ModalKerja from (
SELECT 
a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
...
$query_lancar=" SELECT PihakPenyalur, sum (jumlah)as lancar from (
SELECT 
a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit a 
WHERE 
...
/*
$query_lancar=" SELECT PihakPenyalur, sum (jumlah)as lancar from ( SELECT   a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit A LEFT JOIN (SELECT * FROM DM_InfoDebitur WHERE DataDate='$var_tgl') b ON a.NomorNasabah = b.NomorNasabah 
  WHERE a.DataDate='$var_tgl' AND  a.jenis IN (SELECT Ref_BIGOID_JenisKreditPembiayaan.KodeInternal
  from Ref_BIGOID_JenisKreditPembiayaan WHERE StatusUMKM='y') AND a.GolonganDebitur IN (SELECT Ref_BIGOID_GolonganDebitur.KodeInternal
  FROM Ref_BIGOID_GolonganDebitur WHERE StatusUMKM='y')
...
$query_krg_lancar=" SELECT PihakPenyalur, sum (jumlah)as krg_lancar from (
SELECT 
a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit a 
WHERE 
...
/*
  $query_krg_lancar=" SELECT PihakPenyalur, sum (jumlah)as krg_lancar from SELECT   a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit A LEFT JOIN (SELECT * FROM DM_InfoDebitur WHERE DataDate='$var_tgl') b ON a.NomorNasabah = b.NomorNasabah
...
SELECT  
a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit A LEFT JOIN (SELECT * FROM DM_InfoDebitur WHERE DataDate='$var_tgl') b
...
$query_diragukan=" SELECT PihakPenyalur, sum (jumlah)as macet from (
SELECT 
a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit a 
WHERE 
...
SELECT   a.NamaLengkapDebitur as PihakPenyalur, a.JumlahKreditPeriodeLaporan as jumlah
  FROM $table_asetkredit A LEFT JOIN (SELECT * FROM DM_InfoDebitur WHERE DataDate='$var_tgl') b ON a.NomorNasabah = b.NomorNasabah
WHERE a.DataDate='$var_tgl' AND  a.jenis IN (SELECT Ref_BIGOID_JenisKreditPembiayaan.KodeInternal
from Ref_BIGOID_JenisKreditPembiayaan WHERE StatusUMKM='y')
AND a.GolonganDebitur IN (SELECT Ref_BIGOID_GolonganDebitur.KodeInternal
