...
$objPHPExcel->getActiveSheet()->setCellValue('K8', "=+IF(J8=0,0,(J8/L8))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O8', "=+IF(N8=0,0,(N8/Q8))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S8', "=+IF(M8=0,0,(M8/R8))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('E9', "=+IF(D9=0,0,(D9/C9))");
...
$objPHPExcel->getActiveSheet()->setCellValue('K9', "=+IF(J9=0,0,(J9/L9))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O9', "=+IF(N9=0,0,(N9/Q9))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S9', "=+IF(M9=0,0,(M9/R9))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('E10', "=+IF(D9=0,0,(D9/C9))");
...
$objPHPExcel->getActiveSheet()->setCellValue('K10', "=+IF(J10=0,0,(J10/L10))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O10', "=+IF(N10=0,0,(N10/Q10))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S10', "=+IF(M10=0,0,(M10/R10))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('E11', "=+IF(D11=0,0,(D11/C11))");
...
$objPHPExcel->getActiveSheet()->setCellValue('K11', "=+IF(J11=0,0,(J11/L11))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O11', "=+IF(N11=0,0,(N11/Q11))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S11', "=+IF(M11=0,0,(M11/R11))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K8', "=+IF(J9=0,0,(J8/L9))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O8', "=+IF(N8=0,0,(N8/Q8))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S8', "=+IF(M8=0,0,(M8/R8))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K13', "=+IF(J13=0,0,(J13/L13))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O13', "=+IF(N13=0,0,(N13/Q13))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S13', "=+IF(M13=0,0,(M13/R13))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K14', "=+IF(J9=14,0,(J14/L14))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O14', "=+IF(N8=14,0,(N14/Q14))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S14', "=+IF(M8=14,0,(M14/R14))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K15', "=+IF(J15=0,0,(J15/L15))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O15', "=+IF(N15=0,0,(N15/Q15))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S15', "=+IF(M15=0,0,(M15/R15))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K16', "=+IF(J16=0,0,(J16/L16))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O16', "=+IF(N16=0,0,(N16/Q16))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S16', "=+IF(M16=0,0,(M16/R16))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K17', "=+IF(J17=0,0,(J17/L17))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O17', "=+IF(N17=0,0,(N17/Q17))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S17', "=+IF(M17=0,0,(M17/R17))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K18', "=+IF(J18=0,0,(J18/L18))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O18', "=+IF(N18=0,0,(N18/Q18))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S18', "=+IF(M18=0,0,(M18/R18))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K19', "=+IF(J19=0,0,(J19/L19))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O19', "=+IF(N19=0,0,(N19/Q19))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S19', "=+IF(M19=0,0,(M19/R19))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K20', "=+IF(J20=0,0,(J20/L20))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O20', "=+IF(N20=0,0,(N20/Q20))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S20', "=+IF(M20=0,0,(M20/R20))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K21', "=+IF(J21=0,0,(J21/L9))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O21', "=+IF(N21=0,0,(N21/Q8))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S21', "=+IF(M21=0,0,(M21/R8))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K22', "=+IF(J22=0,0,(J22/L22))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O22', "=+IF(N22=0,0,(N22/Q22))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S22', "=+IF(M22=0,0,(M22/R22))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K23', "=+IF(J23=0,0,(J23/L23))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O23', "=+IF(N23=0,0,(N23/Q23))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S23', "=+IF(M23=0,0,(M23/R23))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K26', "=+IF(J26=0,0,(J26/L26))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O26', "=+IF(N26=0,0,(N26/Q26))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S26', "=+IF(M26=0,0,(M26/R26))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K27', "=+IF(J27=0,0,(J27/L27))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O27', "=+IF(N27=0,0,(N27/Q27))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S27', "=+IF(M27=0,0,(M27/R27))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K28', "=+IF(J28=0,0,(J28/L28))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O28', "=+IF(N28=0,0,(N28/Q28))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S28', "=+IF(M28=0,0,(M28/R28))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K29', "=+IF(J29=0,0,(J29/L29))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O29', "=+IF(N29=0,0,(N29/Q29))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S29', "=+IF(M29=0,0,(M29/R29))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('K30', "=+IF(J30=0,0,(J30/L30))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('O30', "=+IF(N30=0,0,(N30/Q30))/1000000");
$objPHPExcel->getActiveSheet()->setCellValue('S30', "=+IF(M30=0,0,(M30/R30))/1000000");
...
$objPHPExcel->getActiveSheet()->setCellValue('S31', "=+IF(M31=0,0,(M31/R31))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S32', "=+IF(M32=0,0,(M32/R32))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S33', "=+IF(M33=0,0,(M33/R33))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S34', "=+IF(M34=0,0,(M34/R34))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S35', "=+IF(M35=0,0,(M53/R35))");
...
$objPHPExcel->getActiveSheet()->setCellValue('K36', "=+IF(J36=0,0,(J36/L36))");
$objPHPExcel->getActiveSheet()->setCellValue('O36', "=+IF(N36=0,0,(N36/Q36))");
$objPHPExcel->getActiveSheet()->setCellValue('S36', "=+IF(M36=0,0,(M36/R36))");
...
$objPHPExcel->getActiveSheet()->setCellValue('K37', "=+IF(J37=0,0,(J37/L37))");
$objPHPExcel->getActiveSheet()->setCellValue('O37', "=+IF(N37=0,0,(N37/Q37))");
$objPHPExcel->getActiveSheet()->setCellValue('S37', "=+IF(M37=0,0,(M37/R37))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S38', "=+IF(M38=0,0,(M38/R38))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S39', "=+IF(M39=0,0,(M39/R39))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S42', "=+IF(M42=0,0,(M42/R42))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S43', "=+IF(M43=0,0,(M43/R43))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S44', "=+IF(M44=0,0,(M44/R44))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S45', "=+IF(M45=0,0,(M45/R45))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S47', "=+IF(M47=0,0,(M47/R47))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S50', "=+IF(M50=0,0,(M50/R50))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S51', "=+IF(M51=0,0,(M51/R51))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S52', "=+IF(M52=0,0,(M52/R52))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S53', "=+IF(M53=0,0,(M53/R53))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S54', "=+IF(M54=0,0,(M54/R54))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S55', "=+IF(M55=0,0,(M55/R55))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S56', "=+IF(M56=0,0,(M56/R56))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S57', "=+IF(M57=0,0,(M57/R57))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S59', "=+IF(M59=0,0,(M59/R59))");
...
$objPHPExcel->getActiveSheet()->setCellValue('S60', "=+IF(M60=0,0,(M60/R60))");
...
$objWriter->save("Flash_Report_".$label_tgl.".xls");
