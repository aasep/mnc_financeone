...
if (!$res_cek){
        echo "<div class='lert alert-danger'> <br><b> Table $table_asetkredit is not available.</b> <br><br></div>";
        die();
}
/*
...
$objPHPExcel->getActiveSheet()->getStyle('A8:E29')->applyFromArray($styleArrayBorder1);
...
$objPHPExcel->getActiveSheet()->getStyle('A30:Z1000')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('FFFFFF');
/*
...
$objPHPExcel->getActiveSheet()->setCellValue('D7', '(dlm satuan Rupiah penuh)');
...
$objPHPExcel->getActiveSheet()->setCellValue('B21', 'Total KPR/KKBP dengan nominal s.d Rp5 Juta');
$objPHPExcel->getActiveSheet()->setCellValue('A22', '4');
$objPHPExcel->getActiveSheet()->setCellValue('B22', 'Total KP (Kredit Properti)');

$objPHPExcel->getActiveSheet()->setCellValue('A23', '5');
$objPHPExcel->getActiveSheet()->setCellValue('B23', 'KKB (Kredit Kendaraan Bermotor)');

$objPHPExcel->getActiveSheet()->setCellValue('C24', 'Rumah Tangga untuk Pemilikan Mobil Roda Empat');
$objPHPExcel->getActiveSheet()->setCellValue('C25', 'Rumah Tangga untuk Pemilikan Sepeda Bermotor');
$objPHPExcel->getActiveSheet()->setCellValue('C26', 'Rumah Tangga untuk Pemilikan Truk dan Kendaraan Bermotor Roda Enam atau Lebih');
$objPHPExcel->getActiveSheet()->setCellValue('C27', 'Rumah Tangga untuk Pemilikan Kendaraan Bermotor Lainnya');
$objPHPExcel->getActiveSheet()->setCellValue('A28', '6');
$objPHPExcel->getActiveSheet()->setCellValue('B28', 'Total KKB dengan nominal s.d Rp5 Juta');
$objPHPExcel->getActiveSheet()->setCellValue('A29', '7');
$objPHPExcel->getActiveSheet()->setCellValue('B29', 'Total KKB');
...
/*
$objPHPExcel->getActiveSheet()->setCellValue('Z21', floatval($d21));
$objPHPExcel->getActiveSheet()->setCellValue('Z21', floatval($e21));
$objPHPExcel->getActiveSheet()->setCellValue('Z22', floatval($d22));
$objPHPExcel->getActiveSheet()->setCellValue('Z22', floatval($e22));
$objPHPExcel->getActiveSheet()->setCellValue('Z23', floatval($d23));
$objPHPExcel->getActiveSheet()->setCellValue('Z23', floatval($e23));
*/

$d24=$d21+$d22+$d23;
$e24=$e21+$e22+$e23;

$objPHPExcel->getActiveSheet()->setCellValue('D20', floatval($d24));
$objPHPExcel->getActiveSheet()->setCellValue('E20', floatval($e24));

//$objPHPExcel->getActiveSheet()->setCellValue('D24', "=SUM(D21:D23)");
//$objPHPExcel->getActiveSheet()->setCellValue('E24', "=SUM(E21:E23)");

$objPHPExcel->getActiveSheet()->setCellValue('D21', floatval($d25));
$objPHPExcel->getActiveSheet()->setCellValue('E21', floatval($e25));
$objPHPExcel->getActiveSheet()->setCellValue('D22', "=(D19+D20+D21)");
$objPHPExcel->getActiveSheet()->setCellValue('E22', "=(E19+E20+E21)");
//$objPHPExcel->getActiveSheet()->setCellValue('D27', floatval($d27));
//$objPHPExcel->getActiveSheet()->setCellValue('E27', floatval($e27));
$objPHPExcel->getActiveSheet()->setCellValue('D24', floatval($d28));
$objPHPExcel->getActiveSheet()->setCellValue('E24', floatval($e28));
$objPHPExcel->getActiveSheet()->setCellValue('D25', floatval($d29));
$objPHPExcel->getActiveSheet()->setCellValue('E25', floatval($e29));
$objPHPExcel->getActiveSheet()->setCellValue('D26', floatval($d30));
$objPHPExcel->getActiveSheet()->setCellValue('E26', floatval($e30));

$objPHPExcel->getActiveSheet()->setCellValue('D27', floatval($d31));
$objPHPExcel->getActiveSheet()->setCellValue('E27', floatval($e31));
$objPHPExcel->getActiveSheet()->setCellValue('D28', floatval($d32));
$objPHPExcel->getActiveSheet()->setCellValue('E28', floatval($e32));


//$objPHPExcel->getActiveSheet()->setCellValue('D26', "=SUM(D19:D23)");
//$objPHPExcel->getActiveSheet()->setCellValue('E26', "=SUM(E19:E23)");

$objPHPExcel->getActiveSheet()->setCellValue('D29', "=SUM(D24:D28)");
$objPHPExcel->getActiveSheet()->setCellValue('E29', "=SUM(E24:E28)");
...
<div class="portlet box blue" id="flash-report" >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-book"></i> List Laporan LTV
                            </div>
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-advance table-hover"  width="100%">
                                               ...
                                               <tr class="active">
                                                ...
                                                <td  style="font-size:12px" align="right"><?php echo $objPHPExcel->getActiveSheet()->getCell('E27')->getFormattedValue('#,##0,,;(#,##0,,);"-"'); ?></td>
                                                </tr>
                                                <tr>
