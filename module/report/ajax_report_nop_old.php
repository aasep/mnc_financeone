...
if ($found_modal ==0 || !isset($found_modal)){
    echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Anda Harus Menginput Modal diBulan $mon_modal ($year_modal)  terlebih dahulu...!</strong> </div>";
    die();
    }
//echo "$q_modal<br>";
...
#---------------  NOP101000001  Aktiva Valas tidak termasuk giro pada bank lain NOP101000001
$var_nop=" AND b.NOP_Level_3 ='NOP101000001' ";
...
#---------------  NOP101000002  Giro pada bank lain
$var_nop=" AND b.NOP_Level_3 ='NOP101000002' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#---------------  NOP102000001  Pasiva
$var_nop=" AND b.NOP_Level_3 ='NOP102000001' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP201000001 a. Kontrak pembelian forward 
$var_nop=" AND b.NOP_Level_3 ='NOP201000001' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP201000002 b. Kontrak pembelian futures
$var_nop=" AND b.NOP_Level_3 ='NOP201000002' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP201000003 c. Kontrak penjualan put options (bank sebagai writter)
$var_nop=" AND b.NOP_Level_3 ='NOP201000003' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP201000004 d. Kontrak pembelian call options (bank sebagai holder, khusus back to back options)
$var_nop=" AND b.NOP_Level_3 ='NOP201000004' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP201000005 e. Rekening Administratif Tagihan Valas diluar kontrak pemberian forward, futures, dan option
$var_nop=" AND b.NOP_Level_3 ='NOP201000005' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP202000001 a. Kontrak penjualan forward
$var_nop=" AND b.NOP_Level_3 ='NOP202000001' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP202000002 b. Kontrak penjualan futures
$var_nop=" AND b.NOP_Level_3 ='NOP202000002' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP202000003 c.  Kontrak penjualan call options (bank sebagai writter)
$var_nop=" AND b.NOP_Level_3 ='NOP202000003' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
#--------------- NOP202000004 d. Kontrak pembelian put options (bank sebagai holder, khusus back to back option)
$var_nop=" AND b.NOP_Level_3 ='NOP202000004' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
$var_nop=" AND b.NOP_Level_3 ='NOP202000005' ";
$var_curr1=" AND a.JenisMataUang='AUD' ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_curr1.$var_add);
        $row1=odbc_fetch_array($result1);
...
*/
        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_10_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_10_aud=$row1['Jml_Nominal'];


        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_10_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_10_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_10_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_10_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101010000' AND d.NOP_Level_4='NOP101010010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//   NOP101020010    Giro Pada Bank Lain    15  Aktiva valas giro pada bank lain
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_15_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_15_aud=$row1['Jml_Nominal'];


        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_15_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_15_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_15_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_15_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP101020000' AND d.NOP_Level_4='NOP101020010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//   NOP102010010    Pasiva      29  Pasiva valas
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_aud=$row1['Jml_Nominal'];


        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP102010000' AND d.NOP_Level_4='NOP102010010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_29_usd=$row1['Jml_Nominal'];

//  NOP201010000    NOP201010010    32
        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_32_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_32_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_32_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_32_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_32_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_32_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201010000' AND d.NOP_Level_4='NOP201010010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP201020000    NOP201020010    33
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_33_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_33_aud=$row1['Jml_Nominal'];


        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_33_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_33_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_33_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_33_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201020000' AND d.NOP_Level_4='NOP201020010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP201030000    NOP201030010    61
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_61_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_61_aud=$row1['Jml_Nominal'];


        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_61_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_61_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_61_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_61_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201030000' AND d.NOP_Level_4='NOP201030010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP201040000    NOP201040010    69
         ...
         $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_aud=$row1['Jml_Nominal'];


        $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201040000' AND d.NOP_Level_4='NOP201040010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_69_usd=$row1['Jml_Nominal'];

//  NOP201050000    NOP201050010    31
        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_31_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_31_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_31_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_31_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_31_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_31_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP202010000    NOP202010010    39
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202010000' AND d.NOP_Level_4='NOP202010010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_39_usd=$row1['Jml_Nominal'];

//  NOP202020000    NOP202020010    51
        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_51_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_51_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_51_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_51_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_51_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_51_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202020000' AND d.NOP_Level_4='NOP202020010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP202030000    NOP202030010    67
        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_67_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_67_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_67_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_67_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_67_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_67_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202030000' AND d.NOP_Level_4='NOP202030010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP202040000    NOP202040010    65
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_65_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_65_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_65_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_65_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_65_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_65_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202040000' AND d.NOP_Level_4='NOP202040010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
//  NOP202050000    NOP202050010    35
        ...
        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050010' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_35_usd=$row1['Jml_Nominal'];
//  NOP202050000    NOP202050020    52
        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP202050000' AND d.NOP_Level_4='NOP202050020' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_52_usd=$row1['Jml_Nominal'];

//  NOP201050000    NOP201050030    34
        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='IDR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_34_idr=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='AUD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_34_aud=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='EUR'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_34_eur=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='HKD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_34_hkd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='JPY'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_34_jpy=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='SGD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
        $code_34_sgd=$row1['Jml_Nominal'];

        $var_nop=" AND b.NOP_Level_3 ='NOP201050000' AND d.NOP_Level_4='NOP201050030' AND a.JenisMataUang='USD'  ";
        $result1=odbc_exec($connection2, $query.$var_tgl.$var_nop.$var_add);
        $row1=odbc_fetch_array($result1);
...
$objPHPExcel->getActiveSheet()->getStyle('E200:K215')->getNumberFormat()->setFormatCode('#,##0,,;(#,##0,,);"-"');
...
$xcode_15_aud=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('E201')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_15_eur=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('F201')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_15_hkd=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('G201')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_15_jpy=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('H201')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_15_sgd=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('I201')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_15_usd=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('J201')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
...
$xcode_29_aud=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('E202')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_29_eur=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('F202')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_29_hkd=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('G202')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_29_jpy=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('H202')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_29_sgd=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('I202')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
$xcode_29_usd=str_replace(array('(', ')',','), "", $objPHPExcel->getActiveSheet()->getCell('J202')->getFormattedValue('#,##0,,;(#,##0,,);"-"'));
...
<div class="portlet box grey-cascade" id="flash-report" >
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-book"></i> NOP (Net Open Position)
                            </div>
                            <div class="tools">
