...
//echo $query_budget;
//die();
$r_budget=odbc_exec($connection2, $query_budget);
$foundBudget=odbc_num_rows($r_budget);
...
if ($found_budget ==0 || !isset($found_budget)){
	echo "<div class='alert alert-danger alert-dismissable'><b>Data Modal on month $mon_budget - $year_budget is not available. Please select the other date.</b> </div>";
    die();
    }
*/

if ($$foundBudget ==0 || !isset($$foundBudget)){
    echo "<div class='alert alert-danger alert-dismissable'><b>Data Budget on month $mon_budget - $year_budget is not available. Please select the other date.</b> </div>";
   // die();
    }
...
//echo $query_currentDate.$var_curr_mon_min1.$var_flash.$var_flash_add."<br>";
//die();
...
$objPHPExcel->getActiveSheet()->setCellValue('K9', "=+IF(J9=0,0,IF(L9=0,0,(J9/L9)))");
$objPHPExcel->getActiveSheet()->setCellValue('O9', "=+IF(N9=0,0,IF(Q9=0,0,(N9/Q9)))");
...
-->
                    <div class="portlet box blue" id="flash-report" >
                        ...
                        <div class="portlet-body">
							...
							echo "<div class='alert alert-danger'><strong> Data using the tax in $waktu_pajak </div>";
