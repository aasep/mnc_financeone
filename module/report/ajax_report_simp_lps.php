...
FROM $table_giro a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang='IDR' and a.StatusLaporan_LBU='Y'  ";
#--Rekening Giro Valas --
$giro_rek_val=array();
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.status_oncall='Y' and a.StatusLaporan_LBU='Y' ";
...
FROM $table_deposito a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.status_oncall='N' and a.StatusLaporan_LBU='Y' 
";
#--Rekening Deposito Valas --
...
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.flagDPK='Giro' and a.StatusLaporan_LBU='Y' ";
...
/*
--Tabungan--
select sum(jumlahbulanlaporan) from dm_LiabilitasKepadaBankLain_20160930 a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code
...
FROM $table_banklain a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.flagDPK='Tabungan' and a.StatusLaporan_LBU='Y' 
 ";
#--Rekening Tabungan Valas --
$tabungan_rek_val=array();
$query_rek_val =" SELECT COUNT(NoRekening) as Jumlah
...
FROM $table_banklain a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang = 'IDR' AND a.flagDPK='Tabungan'  
 ";
#--Nominal Tabungan Valas--
$tabungan_nom_val=array();
$query_nom_val =" SELECT SUM(jumlahbulanlaporan) as Jumlah
...
foreach ($array_range1 as $value2) {
        ...
        $result2=odbc_exec($connection2, $query_rek_val.$array_range1["$counter2"]);
        $row2=odbc_fetch_array($result2);
        //echo $query_rek_val.$array_range1["$counter2"]."<br>";
        //die();
        array_push($tabungan_rek_val,$row2['Jumlah']);
        #----Nominal Tabungan Rupiah--
        //echo $query_nom_rp.$array_range1["$counter2"];
        //die();
        $result3=odbc_exec($connection2, $query_nom_rp.$array_range1["$counter2"]);
        $row3=odbc_fetch_array($result3);
        array_push($tabungan_nom_rp,$row3['Jumlah']);
...
FROM $table_banklain a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.flagDPK='Deposito'  AND a.status_oncall='Y' and a.StatusLaporan_LBU='Y' ";
#--Rekening Deposito Valas --
$deposito_call_rek_val=array();
$query_rek_val =" SELECT COUNT(NoRekening) as Jumlah
FROM $table_banklain a 
...
FROM $table_banklain a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.flagDPK='Deposito'  AND a.status_oncall='Y'  
 ";
#--Nominal Deposito Valas--
$deposito_call_nom_val=array();
$query_nom_val =" SELECT SUM(jumlahbulanlaporan) as Jumlah
...
FROM $table_banklain a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.flagDPK='Deposito'  AND a.status_oncall='N' and a.StatusLaporan_LBU='Y' ";
#--Rekening Deposito Valas --
$deposito_rek_val=array();
$query_rek_val =" SELECT COUNT(NoRekening) as Jumlah
FROM $table_banklain a 
...
FROM $table_banklain a 
JOIN Referensi_GL_02 b ON b.GLNO = a.Managed_GL_Code AND b.PRODNO = a.Managed_GL_Prod_Code 
WHERE   a.JenisMataUang ='IDR' AND a.flagDPK='Deposito'  AND a.status_oncall='N'  
 ";
#--Nominal Deposito Valas--
$deposito_nom_val=array();
$query_nom_val =" SELECT SUM(jumlahbulanlaporan) as Jumlah
