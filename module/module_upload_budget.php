...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Upload Parameter Budget <span class="step-title">
								 </span>
							</div>
	...
	echo "<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Data berhasil Diupload....!  </strong> </div>";
	...
	?>
												...
												<div class="form-group">
													<label class="control-label col-md-3">Parameter Budget<span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<select class="form-control" name="report_type" id="report_type">
														<option value="">-Pilih  Budget-</option>
														<option value="BS-BUDGET">BS</option>
														<option value="PL-BUDGET">PL</option>
