...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Laporan Suku Bunga Efektif LPS <small></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Suku Bunga Efektif LPS</a>
						<i class="fa fa-angle-right"></i>
					</li>
			...
			<!-- BEGIN VALIDATION STATES-->
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Suku Bunga Efektif LPS
							</div>
							<div class="tools">
...
({
type: "POST",
url: "module/report/ajax_report_skb_efektif.php",
data: dataString1,
cache: false,
