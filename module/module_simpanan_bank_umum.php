...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			Laporan Posisi Simpanan Bank Umum <small></small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<small>
						  <a href="#">Laporan Posisi Simpanan Bank Umum</a>
						</small> 
						<i class="fa fa-angle-right"></i>
					</li>
			...
			<!-- BEGIN VALIDATION STATES-->
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Input Laporan Posisi Simpanan Bank Umum
							</div>
						</div>
								...
								<!-- <div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn blue" type="button" id="exp-flash"> Export <i class="fa fa-download"> </i></button>
...
({
type: "POST",
url: "module/report/ajax_report_simp_bank_umum.php",
data: dataString1,
cache: false,
